...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0004_review_mail_favoriteproduct'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='', max_length=255, verbose_name='Имя клиента')),
                ('last_name', models.CharField(default='', max_length=255, verbose_name='Фамилия клиента')),
